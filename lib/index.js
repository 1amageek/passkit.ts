...
exports.generate = (template, assets, password) => __awaiter(this, void 0, void 0, function* () {
    assets.validate();
    ...
    // Add signature
    const signature = yield manifest.sign(template.passTypeIdentifier, manifestBuffer, password);
